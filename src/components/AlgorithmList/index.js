...
const AlgorithmList = inject('codeStore')(
    class AlgorithmList extends Component {
        constructor() {
            super();
            autoBinding(['changeAlgorithm'],this);
        }

        changeAlgorithm(event) {
            this.props.codeStore.changeAlgorithm(event.key);
        }
                ...
                <Layout>
                    <Sider width={200} style={{ background: '#fff' }}>
                        ...
                        <SubMenu key="sort" title={<span><Icon type="user" />排序</span>}>
                            <Menu.Item key="bubbleSort">冒泡排序</Menu.Item>
                            <Menu.Item key="2">插入排序</Menu.Item>
                            <Menu.Item key="3">合并排序</Menu.Item>
                            <Menu.Item key="quickSort">快速排序</Menu.Item>
                        </SubMenu>
